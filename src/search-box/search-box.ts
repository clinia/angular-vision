...
import { connectSearchBox } from '@clinia/vision/es/connectors';
import { BaseWidget } from '../base-widget';
import { NgCviVision } from '../vision/vision';
import { noop } from '../utils';

@Component({
  selector: 'cvi-search-box',
  template: `
    <div [class]="cx()">
      <form
        [class]="cx('form')"
...
export class NgCviSearchBox extends BaseWidget implements AfterViewInit {
